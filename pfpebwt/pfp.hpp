...
public:
            ...
            head(0)
    {
        ...
        std::cout << "rank test: " << dict.rank_b_s(1) << std::endl;
        std::cout << "rank test: " << dict.rank_b_s(2) << std::endl;
        std::cout << "rank test: " << dict.rank_b_s(52) << std::endl;
        std::cout << "rank test: " << dict.rank_b_s(103) << std::endl;
